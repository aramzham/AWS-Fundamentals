using Customers.Sqs.Api.Mapping;
using Customers.Sqs.Api.Contracts.Messages;
using Customers.Sqs.Api.Domain;
using Customers.Sqs.Api.Messaging;
using Customers.Sqs.Api.Repositories;
...
public class CustomerService : ICustomerService
{
    ...
    public async Task<bool> CreateAsync(Customer customer)
    {
        ...
        if (isCreated)
        {
            await _sqsMessenger.SendMessageAsync(customer.ToCustomerCreated());
        }
    ...
    public async Task<bool> UpdateAsync(Customer customer)
    {
        ...
        if (isUpdated)
        {
            await _sqsMessenger.SendMessageAsync(customer.ToCustomerUpdated());
        }
